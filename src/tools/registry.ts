...
import { executeRemediation } from "./executeRemediationTool";
import { autonomousFix } from "./autonomousFixTool";
...
export const allTools: AgentTool[] = [knowledgeBaseSearch, structuredQuery, assess, correlateAlerts, rememberRemediation, executeRemediation, autonomousFix];
